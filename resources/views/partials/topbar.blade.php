<div class="dark:bg-slate-800 bg-blue-100 px-6 py-3 gap-4">
      <div class="flex items-center justify-center text-center relative">
        <p class="text-[15px] dark:text-white font-medium pr-6 leading-relaxed">🎉 
Ưu đãi có thời hạn! Giảm giá 20% cho lần mua đầu tiên – 
