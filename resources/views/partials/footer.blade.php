<footer class="w-full ">
    <div class="mx-auto container max-w-7xl">
            ...
            <div class="block  xl:max-w-lg">
                ...
                <div
                    ...
                    <input type="text" name="email"
                        class="py-3 px-5 h-14 pl-14 border border-gray-200 rounded-full text-lg text-gray-900 placeholder:text-gray-400 focus:outline-none flex-1 w-full "
                        placeholder="Email" />
                    <button type="submit"
                        class="h-14 py-3.5 px-7 cursor-pointer transition-all duration-500 shadow-md rounded-full text-white font-semibold bg-primary-800 hover:bg-primary-700">Đăng
                        ký</button>
                </div>
            </div>
            <div
                ...
                <div class="block">
                    ...
                    <ul class="grid gap-6 text-center lg:text-left">
                        ...
                        <li><a href="javascript:;" class="text-gray-600 hover:text-primary-800 ">Bảo dưỡng định kỳ</a>
                        </li>
        ...
        <div class="py-9 border-t border-gray-200 dark:border-gray-800">
            <div class="flex items-center justify-center flex-col gap-8 lg:gap-0 sm:flex-row sm:justify-between">
                <span class="text-sm text-gray-500 ">©<a class="capitalize" href="">Thaco thủ đức</a> 2026, All rights
                    reserved.</span>
                <div class="flex  space-x-6 sm:justify-center ">
                    <a href="javascript:;" class="group flex justify-center items-center ">
                        <svg class="text-gray-700 group-hover:text-indigo-600" width="21" height="21"
                    ...
                    <a href="javascript:;" class="group flex justify-center items-center ">
                        <svg class="w-[1.25rem] h-[1.125rem] text-gray-700 group-hover:text-indigo-600"
                    ...
                    <a href="javascript:;" class="group flex justify-center items-center ">
                        <svg class="w-[1rem] h-[1rem] text-gray-700 group-hover:text-indigo-600" viewBox="0 0 13 12"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href="javascript:;" class="group flex justify-center items-center ">
                        <svg class="w-[1.25rem] h-[0.875rem] text-gray-700 group-hover:text-indigo-600"
