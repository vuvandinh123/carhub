<div
    class="relative hover:shadow-lg group transition-shadow border border-gray-200 dark:border-gray-700 card rounded-sm ">
    ...
    <div class="relative mt-3 p-4">
        <p class="uppercase font-semibold text-[9px] mb-1 md:mb-2.5 text-blue-600">
            {{ $post->category->name ?? 'Tin tức' }}</p>
        ...
        <a href="{{ route('posts.show', $post->slug) }}"
            class="font-medium text-xs underline text-blue-600 dark:text-blue-400">Đọc thêm</a>
    </div>
</div>
