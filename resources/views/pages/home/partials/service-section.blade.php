        ...
        <div class="lg:w-1/2 lg:pl-12">
            ...
            <div class="space-y-4 mb-8">
                <div class="flex items-center">
                    ...
                    <span class="text-sub text-lg">We are the UK's largest provider, with more patrols in more
                        places</span>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-sub text-lg">You get 24/7 roadside assistance</span>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-sub text-lg">We fix 4 out of 5 cars at the roadside</span>
                </div>
            </div>
            ...
            <button
                ...
                class="btn-primary cursor-pointer  font-semibold px-8 py-4 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center group">
                Nhận tư vấn
